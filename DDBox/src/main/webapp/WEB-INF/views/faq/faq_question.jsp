...
<div class="page-main">
	...
	<table class="striped-table">
		...
		<tr>
			<td class="align-center"><a href="detail?board_num=${question.board_num}">${question.board_num}</a></td>
			...
			<td class="align-center"><a href="detail?board_num=${question.board_num}">${question.board_title}</a></td>
			<td class="align-center"><a href="detail?board_num=${question.board_num}">${question.board_hit}</a></td>
		</tr>
		</c:forEach>
	</table>
	</c:if>
